    ...
    const blogPosts = [
        {
            ...
            date: 'June 15, 2024',
            summary:
                "Dive into the world of air quality monitoring and learn how EcoTrack's advanced sensors provide crucial insights into the air we breathe.",
        ...
        },
        {
            ...
            date: 'May 28, 2024',
            summary:
                "Explore how EcoTrack's network of weather stations and sensors are uncovering local climate trends and what they mean for your community.",
        ...
        },
        {
            ...
            date: 'May 10, 2024',
            summary:
                "Discover how city planners are using EcoTrack's temperature and humidity data to combat the urban heat island effect and create cooler, more livable cities.",
        ...
        },
        {
            ...
            date: 'April 22, 2024',
            summary:
                "Learn how data from EcoTrack's user-deployed sensors is being used by researchers to gain new insights into environmental patterns and phenomena.",
        ...
        },
        {
            ...
            date: 'April 5, 2024',
            summary:
                "Explore the often-overlooked issue of noise pollution and how EcoTrack's acoustic sensors are helping communities identify and mitigate excessive noise.",
        ...
        },
        {
            ...
            date: 'March 20, 2024',
            summary:
                'Read inspiring case studies of how organizations and communities have used EcoTrack data to implement successful environmental improvement initiatives.',
    ...
    return (
        <Container maxWidth='lg' sx={{ marginTop: 8, marginBottom: 8 }}>
            <StyledSection>
                ...
                <Typography variant='body1' paragraph>
                    Stay informed about the latest in sustainable living,
                    environmental news, and EcoTrack updates.
                </Typography>
            </StyledSection>
