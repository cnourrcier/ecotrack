...
const LocationPage = () => {
    ...
    return (
        <Container maxWidth="lg">
            <StyledSection>
                <Typography variant="h2" gutterBottom>Our Locations</Typography>
                <Typography variant="body1" paragraph>
                    EcoTrack is committed to making a global impact. Find our offices around the world and get in touch with the team nearest to you.
                </Typography>
            </StyledSection>

            <StyledSection>
                {/* Placeholder for a world map component */}
                <Paper elevation={3} sx={{ p: 3, height: 400, display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 4 }}>
                    <Typography variant="body1">World Map placeholder - Showing all EcoTrack locations</Typography>
                </Paper>
            </StyledSection>

            <StyledSection>
                <Typography variant="h4" gutterBottom>Find Us</Typography>
                <Stack spacing={3}>
            ...
            <StyledSection>
                ...
                <Typography variant="body1" paragraph>
                    We welcome visitors to our offices and sensor network facilities. If you'd like to schedule a visit to see our environmental monitoring systems in action or discuss potential data collaborations, please contact the relevant office directly using the information provided above. We look forward to meeting you and exploring how our advanced sensor technology and environmental data analytics can contribute to your research, policy-making, or sustainability initiatives.
                </Typography>
            </StyledSection>
        </Container>
    );
