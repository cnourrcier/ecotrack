...
import { Container, Typography, Box, Accordion, AccordionSummary, AccordionDetails, TextField, InputAdornment, Stack, Chip } from '@mui/material';
...
const FAQPage = () => {
    ...
    const faqItems = [
        ...
        {
            question: "What kind of environmental metrics does EcoTrack monitor?",
        ...
        <Container maxWidth="lg" sx={{ marginTop: 8, marginBottom: 8, }}>
            <StyledSection>
                ...
                <Typography variant="body1" paragraph>
                    Find answers to common questions about EcoTrack and how to use our platform effectively.
                </Typography>
            </StyledSection>
